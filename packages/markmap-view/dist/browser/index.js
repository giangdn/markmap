(function(exports, d32) {
  ...
  class Markmap {
    ...
    async renderData(originData) {
      ...
      mmFoEnter.append("xhtml:body").attr("xmlns", "http://www.w3.org/1999/xhtml").attr(
        "style",
        "margin:0;padding:0;background:transparent;width:100%;height:100%;overflow:visible;"
      ).append("xhtml:div").attr("xmlns", "http://www.w3.org/1999/xhtml").attr("style", (d) => "--node-color:" + color(d)).append("xhtml:div").append("xhtml:div").style("display", "inline-block").html((d) => d.content);
