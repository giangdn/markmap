...
export declare function wrapFunction<T extends unknown[], U>(
  fn: (...args: T) => U,
  wrapper: (fn: (...args: T) => U, ...args: T) => U,
): (...args: T) => U;
export declare function defer<T = void>(): IDeferred<T>;
export declare function memoize<T extends unknown[], U>(
  fn: (...args: T) => U,
): (...args: T) => U;
export declare function debounce<T extends unknown[], U>(
  fn: (...args: T) => U,
  time: number,
): (...args: T) => U | undefined;
